...
LOW_IMPORTANCE_FEATS = ['P_isproton', 'D9_not_na', 'lastest_browser', 'V241',
    ...
    'card5_div_Mean_D8_DOY',  'D7_DT_W_std_score',
    'dist2_div_Mean_D13_DOY_productCD',  'V270',
    'dist2_div_Mean_D14_DOY_productCD',  'id_21',  'V79',
    'TransactionAmt_log1p',  'C7',  'V200',  'V166',  'V154',
    'card5_div_Mean_D8_DOY_productCD',  'V160',
    'card5_div_Mean_D11_DOY_productCD',  'card6_div_Mean_D8_DOY_productCD',
    'V147',  'card4_div_Mean_D8_DOY',  'id_07',  'V280',  'D5_DT_W_min_max',
    'TranAmt_div_Mean_D11_DOY_productCD',  'card1_div_Mean_D8_DOY',
    'card6_div_Mean_D11_DOY_productCD',  'D11_DT_M_min_max',  'V164',  'V90',
    'ProductCD_W_95cents',  'bank_type_D15_mean',  'bank_type_D1_std',
    'V126',  'D12',  'V271',  'V49',  'TranAmt_div_Mean_D8_DOY',  'V215',
    'V47',  'V212',  'bank_type_TransactionAmt_std',
    'dist2_div_Mean_D1_DOY_productCD',  'V36',  'id_11',  'D5_DT_M_std_score',
    'id_02__D8',  'C4_fq_enc',  'card4_div_Mean_D11_DOY_productCD',  'V245',
    'ProductCD_W_NOT_50_95_0_cents',  'card3_div_Mean_D11_DOY_productCD',
    'uid3_D12_std',  'V201',  'uid3_D12_mean',  'bank_type_D10_std',
    'card2_div_Mean_D11_DOY_productCD',  'V85',  'dist2_div_Mean_D10_DOY',
    'D15_to_std_card4',  'card1_div_Mean_D6_DOY_productCD',  'V66',  'V96',
    'V203',  'card2_div_Mean_D8_DOY',  'D13_DT_D_min_max',  'V30',
    'dist2_div_Mean_D9_DOY',  'D13_DT_W_min_max',  'V209',
    'D7_DT_D_std_score',  'V207',  'V81',  'V48',  'bank_type_D4_mean',
    'card3_div_Mean_D7_DOY',  'V99',  'bank_type_D2_mean',
    'bank_type_D7_std',  'V267',  'TranAmt_div_Mean_D7_DOY',  'V274',
    'card2_div_Mean_D8_DOY_productCD',  'id_38',  'card4_count_full',
    'bank_type_D10_mean',  'card3_div_Mean_D6_DOY_productCD',  'V243',
    'D14_DT_D_min_max',  'D5_DT_D_min_max',  'D11_DT_W_min_max',
    'ProductCD_W_50cents',  'V19',  'D3_DT_M_min_max',  'id_15',
    'dist2_div_Mean_D1_DOY',  'id_31_device',  'V259',
    'bank_type_TransactionAmt_mean',  'dist1_div_Mean_D5_DOY',
    'bank_type_D1_mean',  'ProductCD_W_00cents',  'dist1_div_Mean_D2_DOY',
    'V23',  'card1_count_full',  'V298',  'V152',  'V282',  'V221',  'V277',
    'V169',  'V189',  'D11_DT_D_min_max',  'M_na',
    'card4_div_Mean_D9_DOY_productCD',  'V128',  'V220',
    'card5_div_Mean_D6_DOY_productCD',  'V264',  'D2_scaled',  'uid5_D6_std',
    'dist1_div_Mean_D3_DOY',  'card3_div_Mean_D8_DOY',  'V91',
    'card4_div_Mean_D6_DOY_productCD',  'V37',  'D1_scaled',
    'card3_div_Mean_D3_DOY_productCD',  'dist2_div_Mean_D14_DOY',  'V256',
    'D12_DT_M_std_score',  'D14',  'V56',  'V208',  'D3_fq_enc',
    'dist2_div_Mean_D13_DOY',  'V279',  'D3_DT_D_min_max',
    'addr1_count_full',  'card1_div_Mean_D13_DOY_productCD',  'DeviceType',
    'card5_TransactionAmt_std',  'card6_div_Mean_D6_DOY_productCD',  'V291',
    'D9',  'addr1_div_Mean_D5_DOY_productCD',
    'card1_div_Mean_D8_DOY_productCD',  'card5_fq_enc',  'D3_DT_W_min_max',
    'V143',  'uid4_D12_std',  'V266',  'D5_fq_enc',
    'TranAmt_div_Mean_D6_DOY_productCD',  'D4_DT_M_min_max',  'D6_fq_enc',
    'ProductCD_target_mean',  'V13',  'C3_fq_enc',
    'card5_div_Mean_D9_DOY_productCD',  'D5_DT_W_std_score',
    'card6_div_Mean_D9_DOY_productCD',  'card3_div_Mean_D5_DOY_productCD',
    'V12',  'V129',  'V70',  'V131',  'V306',  'ProductCD',
    'card1_div_Mean_D9_DOY',  'card2_div_Mean_D9_DOY',
    'card2_div_Mean_D9_DOY_productCD',  'bank_type_D7_mean',
    'bank_type_D5_mean',  'addr2_div_Mean_D11_DOY',  'card5_div_Mean_D12_DOY',
    'card3_div_Mean_D9_DOY_productCD',  'dist2',  'card1_div_Mean_D6_DOY',
    'V156',  'addr1_div_Mean_D3_DOY_productCD',  'V257',  'C12_fq_enc',
    'card1_div_Mean_D9_DOY_productCD',  'card2_div_Mean_D6_DOY_productCD',
    'V24',  'D6_DT_M_std_score',  'V261',  'bank_type_D3_std',  'V55',
    'addr1_div_Mean_D2_DOY',  'C4',  'uid5_D6_mean',
    'card4_div_Mean_D5_DOY_productCD',  'addr1_div_Mean_D2_DOY_productCD',
    'D3_DT_M_std_score',  'C10_fq_enc',  'uid4_D12_mean',  'email_check',
    'card6_div_Mean_D2_DOY_productCD',  'card4_div_Mean_D9_DOY',  'V67',
    'card5_div_Mean_D6_DOY',  'uid5_D7_std',  'V149',  'D3_DT_W_std_score',
    'card5_div_Mean_D9_DOY',  'V44',  'card5_div_Mean_D13_DOY_productCD',
    'id_33_0',  'D5_DT_D_std_score',  'V77',  'addr1_div_Mean_D3_DOY',
    'addr1_div_Mean_D5_DOY',  'bank_type_D9_mean',  'C5_fq_enc',
    'bank_type_D9_std',  'card1_div_Mean_D12_DOY',
    'card2_div_Mean_D13_DOY_productCD',  'TranAmt_div_Mean_D2_DOY_productCD',
    'uid5_D7_mean',  'V75',  'id_30_fq_enc',  'bank_type_D6_std',
    'D4_DT_W_min_max',  'D15_DT_M_min_max',  'V294',  'D10_DT_M_min_max',
    'bank_type_D2_std',  'D13_DT_M_std_score',  'V20',  'bank_type_D14_mean',
    'card3_div_Mean_D5_DOY',  'bank_type_D12_mean',
    'card6_div_Mean_D5_DOY_productCD',  'V82',  'card3_div_Mean_D2_DOY',
    'card4_div_Mean_D13_DOY_productCD',  'card6_div_Mean_D12_DOY',  'V187',
    'V285',  'V127',  'card4_div_Mean_D2_DOY',
    'card2_div_Mean_D2_DOY_productCD',  'card5_div_Mean_D5_DOY_productCD',
    'M8',  'V38',  'TranAmt_div_Mean_D5_DOY_productCD',
    'dist1_div_Mean_D1_DOY',  'dist1_div_Mean_D4_DOY',
    'card4_div_Mean_D6_DOY',  'card2_div_Mean_D5_DOY_productCD',
    'card6_div_Mean_D9_DOY',  'card1_div_Mean_D13_DOY',
    'TranAmt_div_Mean_D2_DOY',  'V61',  'bank_type_D5_std',
    'card4_div_Mean_D12_DOY',  'id_30_version_fq_enc',  'D15_to_std_addr1',
    'card1_div_Mean_D5_DOY_productCD',  'card5_TransactionAmt_mean',  'V296',
    'D3_DT_D_std_score',  'card6_div_Mean_D6_DOY',
    'card1_div_Mean_D14_DOY_productCD',  'M7',
    'TranAmt_div_Mean_D9_DOY_productCD',  'card5_div_Mean_D2_DOY_productCD',
    'D14_DT_M_std_score',  'bank_type_D13_std',  'bank_type_D14_std',
    'is_december',  'bank_type_D6_mean',  'card3_div_Mean_D3_DOY',
    'card5_div_Mean_D13_DOY',  'addr2_div_Mean_D4_DOY_productCD',
    'card4_div_Mean_D13_DOY',  'TranAmt_div_Mean_D3_DOY_productCD',  'M9',
    'card2_div_Mean_D14_DOY_productCD',  'V165',
    'TranAmt_div_Mean_D13_DOY_productCD',  'V258',  'card1_div_Mean_D14_DOY',
    'D4',  'card2_count_full',  'id_30_version',  'card6_div_Mean_D5_DOY',
    'card4_div_Mean_D5_DOY',  'D11_DT_M_std_score',  'D8_DT_M_min_max',
    'V76',  'TranAmt_div_Mean_D3_DOY',  'C8_fq_enc',  'bank_type_D12_std',
    'bank_type_D8_mean',  'TranAmt_div_Mean_D5_DOY',  'card5_div_Mean_D2_DOY',
