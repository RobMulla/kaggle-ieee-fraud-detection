...
- Train on all data (NO CV) at best iterations
- Add in lb probe to train
...
X_valid = probe_df[FEATURES]
y_valid = probe_df[TARGET]
...
if N_FOLDS == 1:
    ...
    if MODEL_TYPE == 'lightgbm':
        y_pred, y_pred_valid, feature_importance, best_iteration = train_lightgbm(X, y, X_valid, y_valid, X_test, CAT_FEATURES, fold_n, feature_importance)
