...
REMOVE_FEATURES = ['addr1','DT_day', 'D12_DT_D_std_score', 'D12_DT_W_std_score', 'D14_DT_D_min_max',
       'D7_DT_D_std_score', 'D8_DT_D_min_max', 'D8_DT_M_min_max',
       'D8_DT_W_min_max', 'D8_intercept_bin0',
       'TransactionAmt_DT_D_std_score', 'Transaction_day_of_week',
       'Transaction_hour_of_day', 'bank_type_DT_D_hour_dist',
       'bank_type_DT_D_hour_dist_best',
       'bank_type_DT_W_week_day_dist_best', 'card3_DT_D_hour_dist',
       'card3_DT_D_hour_dist_best', 'card3_DT_W_week_day_dist_best',
       'card5_DT_D_hour_dist', 'card5_DT_D_hour_dist_best',
       'card5_DT_W_week_day_dist_best', 'hour_TransactionAmt_mean',
       'hour_TransactionAmt_std', 'hour_V116_mean', 'hour_V116_std',
       'hour_sin', 'D5_fq_enc',
 'bank_type_D7_std',
 'bank_type_D10_std',
 'D14',
